      ...
      (o.prototype.close = function (e) {
        ...
        e && e.preventDefault(),
          ...
          e.isDefaultPrevented() ||
            (a.removeClass("in"), t.support.transition && a.hasClass("fade") ? a.one("bsTransitionEnd", i).emulateTransitionEnd(o.TRANSITION_DURATION) : i());
      });
    var n = t.fn.alert;
    (t.fn.alert = e),
      ...
      (i.prototype.init = function (e, i, o) {
        if (
          ...
          (this.$viewport =
            ...
            t(t.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport)),
